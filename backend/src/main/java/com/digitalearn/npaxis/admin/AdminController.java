...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> addAdmin(@Valid @RequestBody AdminRegisterRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> getPendingPreceptors() {
        log.info("Admin request to fetch pending preceptors");
        List<Preceptor> preceptors = adminService.getPendingPreceptors();
        return ResponseHandler.generateResponse(preceptors, "Pending preceptors fetched successfully", true, HttpStatus.OK);
    }

    @Operation(summary = "Approve a preceptor verification request")
    @PostMapping(value = {APPROVE_PRECEPTOR_API, APPROVE_PRECEPTOR_API + "/"})
    public ResponseEntity<Map<String, Object>> approvePreceptor(@PathVariable Long userId) {
    ...
    public ResponseEntity<Map<String, Object>> rejectPreceptor(@PathVariable Long userId) {
    ...
    public ResponseEntity<Map<String, Object>> toggleUserAccount(@PathVariable Long userId, @RequestParam boolean enabled) {
